...
/datum/controller/subsystem/statpanels/fire(resumed = FALSE)
	if (!resumed)
		...
		global_data += list(
			...
			"Storyteller: [SSgamemode.storyteller ? SSgamemode.storyteller.name : "N/A"][CONFIG_GET(flag/allow_random_events) ? " + Legacy Random Events" : ""]", //VENUS ADDITION: Added Legacy Random Events indicator [CONFIG_GET(flag/allow_random_events) ? " + Legacy Random Events" : ""]
