//IRIS PORT
//TODO: Actually port/add the landmark spawns for this job to the maps via automapper? Funny, it'll require too much effort because maps are always changed, keeping them spawning on shuttle for now
/datum/id_trim/job/explorer
	assignment = JOB_EXPLORER
	trim_icon = 'modular_zzvenus/icons/obj/card.dmi'
...
/datum/outfit/job/explorer
	...
	uniform = /obj/item/clothing/under/rank/cargo/tech //VENUS EDIT - Original: /obj/item/clothing/under/rank/cargo/tech/nova/utility (On IRIS)
...
/obj/item/gps/explorer
	icon = 'modular_zzvenus/icons/obj/devices/tracker.dmi'
	icon_state = "gps-x"
	gpstag = "EXP0"
...
/obj/item/healthanalyzer/simple/explorer
	...
	icon = 'modular_zzvenus/icons/obj/devices/scanner.dmi'
...
/obj/effect/landmark/start/explorer
	name = "Explorer"
	icon = 'modular_zzvenus/icons/mob/landmarks.dmi'
	icon_state = "Explorer"
