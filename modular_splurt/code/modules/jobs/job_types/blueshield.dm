/datum/job/blueshield
	...
	alt_titles = list("Command Security", "Command Guard", "Command Bodyguard", "Sweet Boy", "Sweet Girl", "Penis Case", "Blueguard", "Blueshit", "Captain Mattress", "Syndicate Prime-Defender", "Blueslut", "Red Shield","Bluestud")
