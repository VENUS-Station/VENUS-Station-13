...
/turf/closed/wall/mineral/wood
	...
	hardness = 70
	explosion_block = 0
	canSmoothWith = list(/turf/closed/wall/mineral/wood, /obj/structure/falsewall/wood, /turf/closed/wall/mineral/wood/nonmetal, /turf/closed/wall/indestructible/wood)
