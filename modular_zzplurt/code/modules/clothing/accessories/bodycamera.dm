...
/obj/item/bodycam_upgrade
	...
	icon = 'modular_zzplurt/icons/obj/clothing/bodycamera.dmi'
	 ...
	 */
	var/static/mutable_appearance/equipped_overlay = mutable_appearance('modular_zzplurt/icons/mob/clothing/bodycamera_overlay.dmi', "bodycamera")
